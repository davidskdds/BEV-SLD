...
from utils import read_poses,create_bev_density_image,create_local_coords,save_array_as_tiff,get_config
import os
import shutil
...
for filename in tqdm(pcd_files):
    ...
    if cfg.eval_only is False:
        # create labels
        local_xy = create_local_coords(grid_dim[0],cfg.grid_res)
